    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonUpdateLog_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataLayer.DB.EnableStatistics = true;
                DataTable tableRes = DataLayer.ApplicationLog.UpdateLogChanges3(table);
                RefreshStatistics(DataLayer.DB.LastStatistics);
                DataLayer.DB.EnableStatistics = false;
        ...
        private void buttonViewLogXML_Click(object sender, EventArgs e)
        {
            try
            {
                string xml = DataLayer.ApplicationLog.GetLogAsXML("WinDemo Application");
                System.Windows.Forms.MessageBox.Show(this, xml, "Log XML");
            }
            catch { }
        }
    }
